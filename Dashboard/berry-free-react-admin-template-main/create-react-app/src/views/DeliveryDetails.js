...
export default function ProfilePage() {
    ...
    useEffect(() =>{
        axios.get(`http://localhost:3001/api/deliverypartnerDetails/${id}`)
        .then((response) =>{
          ...
          <MDBCol lg="4">
            <MDBCard className="mb-4">
              <MDBCardBody className="text-center">
                <MDBCardImage
                  src={`http://localhost:3001/${data.user_image}`}
                  style={{ width: '150px' }}
                  fluid />
            ...
            <MDBRow>
              <MDBCol md="6">
                <MDBCard className="mb-4 mb-md-0">
                  ...
                  style={{ width: '250px', height: "300px",alignContent:'center',textAlign:'center'
                   }}
                  fluid />
